...
const AppsDetails = () => {
  ...
  const { companyName, description, downloads, image, ratingAvg, reviews, size, title } = appDetail;

  return (
    <>
      <section className="flex mt-20">
        <Container>
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 pb-14 border-b border-gray-400/40 px-3 md:px-0">
            {/* div left */}
            <figure className="mx-auto">
              <img className="w-20 md:h-80 md:object-cover md:w-96 rounded-2xl shadow-lg" src={image} alt="" />
            </figure>

            <div className="flex-1">
              {/* div right */}
              {/* title and company name */}
              <div className="text-center md:text-start border-b border-gray-400/40 pb-3 md:pb-6">
              ...
              {/* Details */}
              <div className="mt-8 flex flex-wrap items-center justify-between gap-6 text-center bg-white/60 backdrop-blur-sm rounded-xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-white/40">
                {/* Download */}
                <div className="flex-1">
